<?php $reviews = array(
	...
	array(
		...
		'review' => '
			...
			You can\'t put a pricetag on that.</p>'
	),
	array(
		...
		'review' => '
			...
			heller ikke skuffet. NB: Uten kommentarene hadde det nok vært en heller begredelig affære.</p>
			...
			Eventuelt er skuespilleren rett og slett elendig.</p>
	...
	array(
		...
		'review' => '
			...
			peter: det jeg lurer på er hvordan de klarte å unngå å bli saksøkt enda lengre tilbake i steinalderen...</p>
			...
			alexander: oversetteren er av samme kaliber som crewet bak apparently</p>
			...
			<i class="light">*** peter (~taco@217.41.251.134) has quit (Ping timeout: 540 seconds)</i></p>'
	),
	array(
		'title' => 'Future War',
		'year' => '1997',
		...
		'review' => '
			...
			gang til. Alle innvolverte parter i denne produksjonen burde lide en lang og smertefull død.</p>
	...
	array(
		...
		'review' => '
			...
			alexandr: skylder deg juling for den</p>
			...
			[22:33] peter: oh gee, that\'s swell</p>
			...
			peter: VI HAR HØRT DEN FUCKINGS SANGEN EN GANG FOR MYE ALLEREDE</p>
			...
			inge: noen har blitt abusa gjennom oppveksten</p>'
	),
	array(
		...
		'review' => '
			...
			alexandr: 2001?! det ville jeg aldri ha trodd</p>
			...
			inge: musicals er utelukkende fælt</p>
			...
			<p>Husker ikke hva som skjedde på slutten. Ok film, men ingenting verdt å se. Med mindre du er skikkelig bored. Inge synes den er kul.</p>	'
	),
	array(
		'title' => 'Ken Park',
		'year' => '2002',
	...
	array(
		...
		'review' => '
			...
			peter: til nå ja, men jeg nekter å tro at øyeblikket vedvarer</p>
			...
			alexander: herregud, jeg har lyst til å drepe han fuckings missen</p>
			...
			alexander: jeg er litt som den missen som sender sms\'er på mess-tv hvor han forteller alle hvor teite de er som sender sms\'er</p>'
	),
	array(
		...
		'review' => '
			...
			There is absolutely nothing of value here. </p>

			<p>I\'d demand my money back but luckily I wasn\'t dumb enough to pay anything to watch this piece of shit.</p>
			...
			upon any mortal being. Nuns will defecate on your grave for all of eternity. You fucking musical-fan.</p>
			...
			I apologize. I\'ll never do it again.</p>'
	),
	array(
		...
		'review' => '
			...
			alexander: hahaha, ja. dårlig, might I add</p>
			...
			inge: de har sikkert kjørt den samme sekvensen baklengs for å spare film</p>
			...
			alexander: dette er noe av det tristeste jeg har sett</p>
			...
			inge: jeg skjønner ikke hvorfor de har dubba den</p>'
	),
	array(
		'title' => 'Monsturd',
		'year' => '2003',
		...
		'review' => '
			...
			alexander: TIME MEANS NOTHING TO A WARRIOR!</p>
			...
			inge: ES IST EIN LUGER! prima revolver auf der third reich</p>
			...
			inge: HAHAHAHAHHAAHHAHAAH, jeg får ikke puste</p>
	...
	array(
		...
		'review' => '
			...
			peter: ser jo ut som om han spiller i nightwish</p>
			...
			alexander: "i can help her move around in daylight, but she will always be a vampire" ... WHAT THE FUCK ARE YOU DOING YOU TIT?</p>
			...
			alexander: SLÅ PÅ LOMMELYKTENE FOR HELVETE</p>
	...
	array(
		...
		'review' => '
			...
			as for the so called infamous popcorn-scene: It\'s not funny and it\'s not scary. It\'s <i>Troll 2</i>.	</p>'
	)
);